##############################################################################################################################
#			Autores:																										 #
#					Rennan de Lucena Gaio: rennan.gaio12@gmail.com 															 #
#					Victor Barcelos:       vtor.barcellos7@gmail.com 														 #
# 																															 #
# 																															 #
##############################################################################################################################
		...
		while cont < len(FraseRelevante):
			...
			if FraseRelevante[cont][1]=='ENOMEADA' or FraseRelevante[cont][1]=='REFERENCIA':
				...
				if tipoEntidade=='pessoa':
					pontuacao=pontuacao+(0.7+pesoExtra)

				elif FraseRelevante[cont][1]=='REFERENCIA':
					pontuacao=pontuacao+0.3
				else:
					pontuacao=pontuacao+(1+pesoExtra)
